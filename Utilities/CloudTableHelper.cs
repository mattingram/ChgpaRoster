...
namespace Roster.Utilities
{
    public static class CloudTableHelper
    {
        ...
        public static async Task<TableResult> InsertOrMergeEntityAsync(CloudTable table, ITableEntity entity)
        {
            if (entity == null)
            {
        ...
        /// <returns>A Task object</returns>
        public static async Task DeleteEntityAsync(CloudTable table, ITableEntity deleteEntity)
        {
            try
            {
